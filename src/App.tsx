...
import { Pill, ShieldCheck, Heart, Sparkles, AlertCircle, RefreshCw, Search } from 'lucide-react';
          ...
          <div>
            ...
            <div className="max-w-5xl mx-auto px-4 mt-8">
              ...
              {loadingData ? (
                ...
                /* REAL-TIME SEARCH LOADING CARD (4 SECONDS WITH LOADING ICON) */
                <div className="bg-white rounded-3xl p-10 sm:p-14 text-center border-2 border-slate-200 shadow-sm max-w-2xl mx-auto my-6">
                  <div className="relative w-16 h-16 mx-auto mb-5 flex items-center justify-center">
                    <div className="absolute inset-0 rounded-full border-4 border-lime-200 animate-ping opacity-75" />
                    <RefreshCw className="w-10 h-10 text-lime-600 animate-spin" />
                  </div>
                  <h3 className="text-xl sm:text-2xl font-black text-slate-900 mb-2">
                    Pesquisando Interações em Tempo Real...
                  </h3>
                  <p className="text-sm font-medium text-slate-600 max-w-md mx-auto leading-relaxed">
                    Consultando base de dados farmacológica e cruzando informações para <strong className="text-slate-900">"{searchExecutedTerm}"</strong>. Por favor, aguarde...
                  </p>
                  
                  {/* Visual 4-second Progress Indicator */}
                  <div className="w-full bg-slate-100 rounded-full h-2.5 mt-6 overflow-hidden max-w-xs mx-auto border border-slate-200">
                    <div className="bg-lime-400 h-full rounded-full animate-[pulse_1s_infinite]" />
                  </div>
                </div>
              ) : !searchExecutedTerm ? (
                ...
                <div className="space-y-6">
                  <div className="flex items-center justify-between px-2 text-xs text-slate-500 font-bold">
                    <span>Resultado da Pesquisa para "{searchExecutedTerm}"</span>
